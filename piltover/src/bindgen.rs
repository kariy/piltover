...
AppchainContract < A >
{
    ...
    Self
    {
        Self
        {
            ...
            :: Tag(starknet :: core :: types :: BlockTag :: PreConfirmed)
        }
    } pub fn
    ...
    { Self { block_id, .. self } }
} #[derive()] pub struct AppchainContractReader < P : starknet :: providers ::
Provider + Sync >
{
    pub address : starknet :: core :: types :: Felt, pub provider : P, pub
    block_id : starknet :: core :: types :: BlockId,
} impl < P : starknet :: providers :: Provider + Sync > AppchainContractReader
< P >
{
...
} impl LogStateTransitionFact
{
    ...
    {
        starknet :: core :: utils ::
        get_selector_from_name("LogStateTransitionFact").unwrap()
    } pub fn event_name() -> & 'static str { "LogStateTransitionFact" }
} #[derive()] pub struct LogStateUpdate
{
...
} impl LogStateUpdate
{
    ...
    {
        starknet :: core :: utils ::
        get_selector_from_name("LogStateUpdate").unwrap()
    } pub fn event_name() -> & 'static str { "LogStateUpdate" }
} #[derive()] pub struct MessageCanceled
{
...
} impl MessageCanceled
{
    ...
    {
        starknet :: core :: utils ::
        get_selector_from_name("MessageCanceled").unwrap()
    } pub fn event_name() -> & 'static str { "MessageCanceled" }
} #[derive()] pub struct MessageCancellationStarted
{
    pub message_hash : starknet :: core :: types :: Felt, pub from : cainome
    :: cairo_serde :: ContractAddress, pub to : cainome :: cairo_serde ::
    ContractAddress, pub selector : starknet :: core :: types :: Felt, pub
...
} impl MessageCancellationStarted
{
    ...
    {
        starknet :: core :: utils ::
        get_selector_from_name("MessageCancellationStarted").unwrap()
    } pub fn event_name() -> & 'static str { "MessageCancellationStarted" }
} #[derive()] pub struct MessageConsumed
{
    pub message_hash : starknet :: core :: types :: Felt, pub from : cainome
    :: cairo_serde :: ContractAddress, pub to : cainome :: cairo_serde ::
...
} impl MessageConsumed
{
    ...
    {
        starknet :: core :: utils ::
        get_selector_from_name("MessageConsumed").unwrap()
    } pub fn event_name() -> & 'static str { "MessageConsumed" }
} #[derive()] pub struct MessageSent
{
    pub message_hash : starknet :: core :: types :: Felt, pub from : cainome
    :: cairo_serde :: ContractAddress, pub to : cainome :: cairo_serde ::
    ContractAddress, pub selector : starknet :: core :: types :: Felt, pub
...
} impl MessageToStarknetReceived
{
    ...
    {
        starknet :: core :: utils ::
        get_selector_from_name("MessageToStarknetReceived").unwrap()
    } pub fn event_name() -> & 'static str { "MessageToStarknetReceived" }
} #[derive()] pub struct OwnershipTransferStarted
{
...
} impl OwnershipTransferStarted
{
    ...
    {
        starknet :: core :: utils ::
        get_selector_from_name("OwnershipTransferStarted").unwrap()
    } pub fn event_name() -> & 'static str { "OwnershipTransferStarted" }
} #[derive()] pub struct OwnershipTransferred
{
    pub previous_owner : cainome :: cairo_serde :: ContractAddress, pub
    new_owner : cainome :: cairo_serde :: ContractAddress
...
{
    pub bootloader_program_hash : starknet :: core :: types :: Felt, pub
    snos_config_hash : starknet :: core :: types :: Felt, pub
    snos_program_hash : starknet :: core :: types :: Felt, pub
    layout_bridge_program_hash : starknet :: core :: types :: Felt
} impl cainome :: cairo_serde :: CairoSerde for ProgramInfo
{
    ...
    {
        let mut __size = 0; __size += starknet :: core :: types :: Felt ::
        cairo_serialized_size(& __rust.bootloader_program_hash); __size +=
        starknet :: core :: types :: Felt ::
        cairo_serialized_size(& __rust.snos_config_hash); __size += starknet
        :: core :: types :: Felt ::
        cairo_serialized_size(& __rust.snos_program_hash); __size += starknet
        :: core :: types :: Felt ::
        cairo_serialized_size(& __rust.layout_bridge_program_hash); __size
    } fn cairo_serialize(__rust : & Self :: RustType) -> Vec < starknet ::
    core :: types :: Felt >
    {
        let mut __out : Vec < starknet :: core :: types :: Felt > = vec! [];
        __out.extend(starknet :: core :: types :: Felt ::
        cairo_serialize(& __rust.bootloader_program_hash));
        __out.extend(starknet :: core :: types :: Felt ::
        cairo_serialize(& __rust.snos_config_hash));
        __out.extend(starknet :: core :: types :: Felt ::
        cairo_serialize(& __rust.snos_program_hash));
        __out.extend(starknet :: core :: types :: Felt ::
        cairo_serialize(& __rust.layout_bridge_program_hash)); __out
    } fn
    cairo_deserialize(__felts : & [starknet :: core :: types :: Felt],
    __offset : usize) -> cainome :: cairo_serde :: Result < Self :: RustType >
    {
        let mut __offset = __offset; let bootloader_program_hash = starknet ::
        core :: types :: Felt :: cairo_deserialize(__felts, __offset) ? ;
        __offset += starknet :: core :: types :: Felt ::
        cairo_serialized_size(& bootloader_program_hash); let snos_config_hash
        = starknet :: core :: types :: Felt ::
        cairo_deserialize(__felts, __offset) ? ; __offset += starknet :: core
        :: types :: Felt :: cairo_serialized_size(& snos_config_hash); let
        snos_program_hash = starknet :: core :: types :: Felt ::
        cairo_deserialize(__felts, __offset) ? ; __offset += starknet :: core
        :: types :: Felt :: cairo_serialized_size(& snos_program_hash); let
        layout_bridge_program_hash = starknet :: core :: types :: Felt ::
        cairo_deserialize(__felts, __offset) ? ; __offset += starknet :: core
        :: types :: Felt ::
        cairo_serialized_size(& layout_bridge_program_hash);
        Ok(ProgramInfo
        {
            bootloader_program_hash, snos_config_hash, snos_program_hash,
...
} impl Upgraded
{
    ...
    {
        starknet :: core :: utils ::
        get_selector_from_name("Upgraded").unwrap()
    } pub fn event_name() -> & 'static str { "Upgraded" }
} #[derive()] pub enum AppchainEvent
{
    OwnableEvent(OwnableEvent), UpgradeableEvent(UpgradeableEvent),
    ConfigEvent(ConfigEvent), MessagingEvent(MessagingEvent),
    ReentrancyGuardEvent(ReentrancyguardEvent), StateEvent(StateEvent),
...
} impl cainome :: cairo_serde :: CairoSerde for AppchainEvent
{
    ...
    cairo_serialized_size(__rust : & Self :: RustType) -> usize
    {
        match __rust
        {
            AppchainEvent :: OwnableEvent(val) => OwnableEvent ::
            cairo_serialized_size(val) + 1, AppchainEvent ::
            UpgradeableEvent(val) => UpgradeableEvent ::
            cairo_serialized_size(val) + 1, AppchainEvent :: ConfigEvent(val)
            => ConfigEvent :: cairo_serialized_size(val) + 1, AppchainEvent ::
            MessagingEvent(val) => MessagingEvent ::
            cairo_serialized_size(val) + 1, AppchainEvent ::
            ReentrancyGuardEvent(val) => ReentrancyguardEvent ::
            cairo_serialized_size(val) + 1, AppchainEvent :: StateEvent(val)
            => StateEvent :: cairo_serialized_size(val) + 1, AppchainEvent ::
            LogStateUpdate(val) => LogStateUpdate ::
            cairo_serialized_size(val) + 1, AppchainEvent ::
    ...
    core :: types :: Felt >
    {
        match __rust
        {
            AppchainEvent :: OwnableEvent(val) =>
            {
                ...
                temp.extend(OwnableEvent :: cairo_serialize(val)); temp
            }, AppchainEvent :: UpgradeableEvent(val) =>
            {
                let mut temp = vec! [];
                temp.extend(usize :: cairo_serialize(& 1usize));
                temp.extend(UpgradeableEvent :: cairo_serialize(val)); temp
            }, AppchainEvent :: ConfigEvent(val) =>
            {
                let mut temp = vec! [];
                temp.extend(usize :: cairo_serialize(& 2usize));
                temp.extend(ConfigEvent :: cairo_serialize(val)); temp
            }, AppchainEvent :: MessagingEvent(val) =>
            {
                let mut temp = vec! [];
                temp.extend(usize :: cairo_serialize(& 3usize));
                temp.extend(MessagingEvent :: cairo_serialize(val)); temp
            ...
            }, AppchainEvent :: StateEvent(val) =>
            {
                ...
                temp.extend(StateEvent :: cairo_serialize(val)); temp
    ...
    __offset : usize) -> cainome :: cairo_serde :: Result < Self :: RustType >
    {
        ...
        __index as usize
        {
            ...
            Ok(AppchainEvent ::
            StateEvent(StateEvent :: cairo_deserialize(__felts, __offset + 1)
            ?)), 6usize =>
            Ok(AppchainEvent ::
            LogStateUpdate(LogStateUpdate ::
            ...
            Deserialize(format!
            ("Index not handle for enum {}", "AppchainEvent")))
        }
    }
...
{
    type Error = String; fn
    try_from(event : & starknet :: core :: types :: Event) -> Result < Self,
    Self :: Error >
    {
        use cainome :: cairo_serde :: CairoSerde; if event.keys.is_empty()
        { return Err("Event has no key".to_string()); } let selector =
...
} #[derive()] pub enum ConfigEvent { ProgramInfoChanged(ProgramInfoChanged) }
impl cainome :: cairo_serde :: CairoSerde for ConfigEvent
{
    ...
    cairo_serialized_size(__rust : & Self :: RustType) -> usize
    {
        match __rust
        {
            ConfigEvent :: ProgramInfoChanged(val) => ProgramInfoChanged ::
            cairo_serialized_size(val) + 1, _ => 0
        }
    } fn cairo_serialize(__rust : & Self :: RustType) -> Vec < starknet ::
    core :: types :: Felt >
    ...
    __offset : usize) -> cainome :: cairo_serde :: Result < Self :: RustType >
    {
        ...
        __index as usize
        {
            ...
            Err(cainome :: cairo_serde :: Error ::
            Deserialize(format!
            ("Index not handle for enum {}", "ConfigEvent")))
        }
    }
...
} #[derive()] pub enum MessageToAppchainStatus
{
    NotSent, Sealed, Cancelled, Pending(starknet :: core :: types :: Felt),
    Cancelling
} impl cainome :: cairo_serde :: CairoSerde for MessageToAppchainStatus
{
    ...
    cairo_serialized_size(__rust : & Self :: RustType) -> usize
    {
        match __rust
        {
            MessageToAppchainStatus :: NotSent => 1, MessageToAppchainStatus
            :: Sealed => 1, MessageToAppchainStatus :: Cancelled => 1,
            MessageToAppchainStatus :: Pending(val) => starknet :: core ::
            types :: Felt :: cairo_serialized_size(val) + 1,
            MessageToAppchainStatus :: Cancelling => 1, _ => 0
        }
    } fn cairo_serialize(__rust : & Self :: RustType) -> Vec < starknet ::
    core :: types :: Felt >
    {
        match __rust
        {
            MessageToAppchainStatus :: NotSent => usize ::
            cairo_serialize(& 0usize), MessageToAppchainStatus :: Sealed =>
            usize :: cairo_serialize(& 1usize), MessageToAppchainStatus ::
            Cancelled => usize :: cairo_serialize(& 2usize),
            ...
            }, MessageToAppchainStatus :: Cancelling => usize ::
            cairo_serialize(& 4usize), _ => vec! []
        }
    } fn
    cairo_deserialize(__felts : & [starknet :: core :: types :: Felt],
    __offset : usize) -> cainome :: cairo_serde :: Result < Self :: RustType >
    {
        ...
        __index as usize
        {
            0usize => Ok(MessageToAppchainStatus :: NotSent), 1usize =>
            Ok(MessageToAppchainStatus :: Sealed), 2usize =>
            Ok(MessageToAppchainStatus :: Cancelled), 3usize =>
            Ok(MessageToAppchainStatus ::
            Pending(starknet :: core :: types :: Felt ::
            cairo_deserialize(__felts, __offset + 1) ?)), 4usize =>
            Ok(MessageToAppchainStatus :: Cancelling), _ => return
            Err(cainome :: cairo_serde :: Error ::
            Deserialize(format!
            ("Index not handle for enum {}", "MessageToAppchainStatus")))
        }
    }
} #[derive()] pub enum MessageToStarknetStatus
...
} #[derive()] pub enum MessagingEvent
{
...
} impl cainome :: cairo_serde :: CairoSerde for MessagingEvent
{
    ...
    cairo_serialized_size(__rust : & Self :: RustType) -> usize
    {
        match __rust
        {
            MessagingEvent :: MessageSent(val) => MessageSent ::
            cairo_serialized_size(val) + 1, MessagingEvent ::
            MessageConsumed(val) => MessageConsumed ::
            cairo_serialized_size(val) + 1, MessagingEvent ::
            MessageCancellationStarted(val) => MessageCancellationStarted ::
            cairo_serialized_size(val) + 1, MessagingEvent ::
            MessageCanceled(val) => MessageCanceled ::
            cairo_serialized_size(val) + 1, MessagingEvent ::
    ...
    __offset : usize) -> cainome :: cairo_serde :: Result < Self :: RustType >
    {
        ...
        __index as usize
        {
            ...
            Err(cainome :: cairo_serde :: Error ::
            Deserialize(format!
            ("Index not handle for enum {}", "MessagingEvent")))
        }
    }
} impl TryFrom < & starknet :: core :: types :: EmittedEvent > for
MessagingEvent
...
} impl cainome :: cairo_serde :: CairoSerde for OwnableEvent
{
    ...
    cairo_serialized_size(__rust : & Self :: RustType) -> usize
    {
        match __rust
        {
            OwnableEvent :: OwnershipTransferred(val) => OwnershipTransferred
            :: cairo_serialized_size(val) + 1, OwnableEvent ::
    ...
    __offset : usize) -> cainome :: cairo_serde :: Result < Self :: RustType >
    {
        ...
        __index as usize
        {
            ...
            Err(cainome :: cairo_serde :: Error ::
            Deserialize(format!
            ("Index not handle for enum {}", "OwnableEvent")))
        }
    }
} impl TryFrom < & starknet :: core :: types :: EmittedEvent > for
OwnableEvent
...
} #[derive()] pub enum ReentrancyguardEvent {} impl cainome :: cairo_serde ::
CairoSerde for ReentrancyguardEvent
{
    type RustType = Self; const SERIALIZED_SIZE : std :: option :: Option <
    usize > = std :: option :: Option :: None; #[inline] fn
    cairo_serialized_size(__rust : & Self :: RustType) -> usize
    ...
    __offset : usize) -> cainome :: cairo_serde :: Result < Self :: RustType >
    {
        ...
        __index as usize
        {
            ...
            Err(cainome :: cairo_serde :: Error ::
            Deserialize(format!
            ("Index not handle for enum {}", "ReentrancyguardEvent")))
        }
    }
} impl TryFrom < & starknet :: core :: types :: EmittedEvent > for
...
} impl TryFrom < & starknet :: core :: types :: Event > for
ReentrancyguardEvent
{
    type Error = String; fn
    try_from(event : & starknet :: core :: types :: Event) -> Result < Self,
...
} #[derive()] pub enum StateEvent {} impl cainome :: cairo_serde :: CairoSerde
for StateEvent
{
    type RustType = Self; const SERIALIZED_SIZE : std :: option :: Option <
    usize > = std :: option :: Option :: None; #[inline] fn
    ...
    __offset : usize) -> cainome :: cairo_serde :: Result < Self :: RustType >
    {
        ...
        __index as usize
        {
            ...
            Err(cainome :: cairo_serde :: Error ::
            Deserialize(format!
            ("Index not handle for enum {}", "StateEvent")))
        }
    }
...
} #[derive()] pub enum UpgradeableEvent { Upgraded(Upgraded) } impl cainome ::
cairo_serde :: CairoSerde for UpgradeableEvent
{
    type RustType = Self; const SERIALIZED_SIZE : std :: option :: Option <
    usize > = std :: option :: Option :: None; #[inline] fn
    cairo_serialized_size(__rust : & Self :: RustType) -> usize
    {
        match __rust
        {
            UpgradeableEvent :: Upgraded(val) => Upgraded ::
            cairo_serialized_size(val) + 1, _ => 0
        }
    } fn cairo_serialize(__rust : & Self :: RustType) -> Vec < starknet ::
    core :: types :: Felt >
    ...
    __offset : usize) -> cainome :: cairo_serde :: Result < Self :: RustType >
    {
        ...
        __index as usize
        {
            ...
            Err(cainome :: cairo_serde :: Error ::
            Deserialize(format!
            ("Index not handle for enum {}", "UpgradeableEvent")))
        }
    }
} impl TryFrom < & starknet :: core :: types :: EmittedEvent > for
UpgradeableEvent
{
    ...
    Self, Self :: Error >
    {
        ...
        ("Invalid selector for {}", "Upgraded"))
        {
            ...
            cairo_serialized_size(& class_hash); return
            Ok(UpgradeableEvent :: Upgraded(Upgraded { class_hash }))
        };
        Err(format! ("Could not match any event from keys {:?}", event.keys))
    }
...
AppchainContract < A >
{
    ...
    fn pending_owner(& self,) -> cainome :: cairo_serde :: call :: FCall < A
    :: Provider, cainome :: cairo_serde :: ContractAddress >
    {
        use cainome :: cairo_serde :: CairoSerde; let mut __calldata = vec!
        []; let __call = starknet :: core :: types :: FunctionCall
        {
            contract_address : self.address, entry_point_selector : starknet
            :: macros :: selector! ("pending_owner"), calldata : __calldata,
        }; cainome :: cairo_serde :: call :: FCall ::
        new(__call, self.provider(),)
    } #[allow(clippy :: ptr_arg)] #[allow(clippy :: too_many_arguments)] pub
    fn
    ...
    fn accept_ownership_getcall(& self,) -> starknet :: core :: types :: Call
    {
        use cainome :: cairo_serde :: CairoSerde; let mut __calldata = vec!
        []; starknet :: core :: types :: Call
        {
            to : self.address, selector : starknet :: macros :: selector!
            ("accept_ownership"), calldata : __calldata,
        }
    } #[allow(clippy :: ptr_arg)] #[allow(clippy :: too_many_arguments)] pub
    fn accept_ownership(& self,) -> starknet :: accounts :: ExecutionV3 < A >
    {
        use cainome :: cairo_serde :: CairoSerde; let mut __calldata = vec!
    ...
    ContractAddress, selector : & starknet :: core :: types :: Felt, payload :
    & Vec :: < starknet :: core :: types :: Felt > , nonce : & starknet ::
    core :: types :: Felt) -> starknet :: accounts :: ExecutionV3 < A >
    {
        use cainome :: cairo_serde :: CairoSerde; let mut __calldata = vec!
        [];
        __calldata.extend(cainome :: cairo_serde :: ContractAddress ::
    ...
    cairo_serde :: ContractAddress, payload : & Vec :: < starknet :: core ::
    types :: Felt >) -> starknet :: accounts :: ExecutionV3 < A >
    {
        use cainome :: cairo_serde :: CairoSerde; let mut __calldata = vec!
        [];
        __calldata.extend(cainome :: cairo_serde :: ContractAddress ::
    ...
    ContractAddress) -> starknet :: accounts :: ExecutionV3 < A >
    {
        use cainome :: cairo_serde :: CairoSerde; let mut __calldata = vec!
        [];
        __calldata.extend(cainome :: cairo_serde :: ContractAddress ::
    ...
    fn renounce_ownership_getcall(& self,) -> starknet :: core :: types ::
    Call
    {
        use cainome :: cairo_serde :: CairoSerde; let mut __calldata = vec!
        []; starknet :: core :: types :: Call
    ...
    fn renounce_ownership(& self,) -> starknet :: accounts :: ExecutionV3 < A
    >
    {
        use cainome :: cairo_serde :: CairoSerde; let mut __calldata = vec!
        []; let __call = starknet :: core :: types :: Call
    ...
    starknet :: core :: types :: Felt) -> starknet :: accounts :: ExecutionV3
    < A >
    {
        use cainome :: cairo_serde :: CairoSerde; let mut __calldata = vec!
        [];
    ...
    ContractAddress) -> starknet :: core :: types :: Call
    {
        ...
        [];
        __calldata.extend(cainome :: cairo_serde :: ContractAddress ::
        cairo_serialize(new_owner)); starknet :: core :: types :: Call
        {
            to : self.address, selector : starknet :: macros :: selector!
    ...
    ContractAddress) -> starknet :: accounts :: ExecutionV3 < A >
    {
        ...
        [];
        __calldata.extend(cainome :: cairo_serde :: ContractAddress ::
        cairo_serialize(new_owner)); let __call = starknet :: core :: types ::
        Call
        {
            to : self.address, selector : starknet :: macros :: selector!
            ("transfer_ownership"), calldata : __calldata,
    ...
    types :: Felt > , layout_bridge_output : & Vec :: < starknet :: core ::
    types :: Felt >) -> starknet :: core :: types :: Call
    {
        use cainome :: cairo_serde :: CairoSerde; let mut __calldata = vec!
        [];
        ...
        __calldata.extend(Vec :: < starknet :: core :: types :: Felt > ::
        cairo_serialize(layout_bridge_output)); starknet :: core :: types ::
        Call
        {
            to : self.address, selector : starknet :: macros :: selector!
    ...
    Felt > , layout_bridge_output : & Vec :: < starknet :: core :: types ::
    Felt >) -> starknet :: accounts :: ExecutionV3 < A >
    {
        use cainome :: cairo_serde :: CairoSerde; let mut __calldata = vec!
        [];
        __calldata.extend(Vec :: < starknet :: core :: types :: Felt > ::
        cairo_serialize(snos_output));
        __calldata.extend(Vec :: < starknet :: core :: types :: Felt > ::
        cairo_serialize(layout_bridge_output)); let __call = starknet :: core
        :: types :: Call
        {
            to : self.address, selector : starknet :: macros :: selector!
            ("update_state"), calldata : __calldata,
...
< P >
{
    ...
    fn pending_owner(& self,) -> cainome :: cairo_serde :: call :: FCall < P,
    cainome :: cairo_serde :: ContractAddress >
    {
        use cainome :: cairo_serde :: CairoSerde; let mut __calldata = vec!
        []; let __call = starknet :: core :: types :: FunctionCall
